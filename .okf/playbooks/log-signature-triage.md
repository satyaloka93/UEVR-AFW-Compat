...
| Title splash then indefinite "waiting" | Ambiguous in TOW2: CVar scan, incomplete view-extension discovery, or GameThread UObject traversal | Check for `Found final frame count`; then [/fixes/tow2-cvar-scanner-bypass.md](/fixes/tow2-cvar-scanner-bypass.md), [/fixes/tow2-view-extension-analyzer-threshold.md](/fixes/tow2-view-extension-analyzer-threshold.md), and capture [/playbooks/in-process-hang-dump.md](/playbooks/in-process-hang-dump.md) |
