...
* [Silent Hill f](silent-hill-f.md) — documented baseline UE5.7/OpenXR bring-up through tags `57shf54` and `shf57`; Native stable UI/scene-copy path, VRS rejected, AFW unvalidated.
